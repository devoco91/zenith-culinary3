              ...
              <div className="border-t border-gray-200 pt-8">
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <button
                    ...
                    className="flex-1 bg-red-500 hover:bg-red-600 text-white py-4 px-8 rounded-xl font-semibold text-center transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1m0-9V6m0 0a9 9 0 100 18 9 9 0 000-18z" />
                    </svg>
                    Logout
                  </button>
                </div>
